...
const DiscoveryTabs: React.FC = () => {
  ...
  // Get products for the active category to display as circular icons
  const categoryProducts = mockProducts.filter(p => p.category === activeCategory).slice(0, 12);
